...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_calculators_and_component_reference_modules_are_public(self):
        ...
        datasheets_js = (self.dist / "assets" / "datasheet-finder.js").read_text(encoding="utf-8")
        ...
        self.assertNotIn("id:'ducts'", calculators_js)
        ...
        self.assertIn("assets/datasheet-finder.js", components_html)
        self.assertIn("ST_DATASHEETS", components_js)
        self.assertIn("Mouser", datasheets_js)
        self.assertIn("DigiKey", datasheets_js)
        self.assertIn("Farnell", datasheets_js)
        self.assertIn("TME", datasheets_js)
        self.assertIn("Google PDF", datasheets_js)
        self.assertNotIn("api_key", datasheets_js.lower())
    ...
    def test_duct_designer_is_an_independent_visual_project_tool(self):
        ...
        portal = (self.dist / "index.html").read_text(encoding="utf-8")
        self.assertIn("Un solo plano, sin pasos que te corten", html)
        self.assertIn('id="phaseAction"', html)
        self.assertIn('id="ductHeightCm"', html)
        self.assertIn('id="grilleHeightCm"', html)
        self.assertIn('id="automaticResult"', html)
        self.assertNotIn('class="assistant-steps"', html)
        self.assertNotIn('data-go-step=', html)
        self.assertNotIn('id="roomType"', html)
        self.assertNotIn('id="machineCapacityFg"', html)
        self.assertNotIn('id="loadPerM2"', html)
        self.assertNotIn('id="airflowPer9000"', html)
        self.assertNotIn('id="areaPer9000"', html)
        self.assertNotIn('id="grilleMultiplier"', html)
        self.assertNotIn('data-tool="duct"', html)
        self.assertNotIn('data-tool="outlet"', html)
        self.assertNotIn('id="roomDialog"', html)
        self.assertIn("calculateProject", script)
        self.assertIn("renderPlanSvg", script)
        self.assertIn("automaticNetwork", script)
        self.assertIn("chooseOutletPlacement", script)
        self.assertIn("snapOutletToWall", script)
        self.assertIn("wallSegments", script)
        self.assertIn("polygonSelfIntersects", script)
        self.assertIn("st.ductDesigner.v6", script)
        self.assertIn("ROOM_LOADS", script)
        self.assertIn("ductVelocityMps", script)
        self.assertIn("outletOverrides", script)
        self.assertIn("branchGuides", script)
        self.assertIn("trunkGuide", script)
        self.assertIn("branchWaypoints", script)
        self.assertIn("trunkWaypoints", script)
        self.assertIn("layoutSectionLabels", script)
        self.assertIn("snapMachineToPlan", script)
        self.assertIn("setPointerCapture", script)
        self.assertIn("selectedAdjustment", script)
        self.assertIn("Rejilla seleccionada", script)
        self.assertIn("rejillas alineadas con sus paredes", script)
        self.assertIn('data-kind="outlet-drag"', script)
        self.assertIn('data-kind="branch-drag"', script)
        self.assertIn('data-kind="trunk-drag"', script)
        self.assertIn('data-kind="machine-drag"', script)
        self.assertIn("roundUp(Math.max(DESIGN.minimumDuctWidthCm, rawWidthCm), 5)", script)
        self.assertIn("installation-plan", css)
        self.assertIn("finish-drawing", css)
        self.assertIn("room-type-editor", css)
        self.assertIn("zone-toggle", css)
        self.assertIn("machine-toggle", css)
        ...
        self.assertIn("duct-adjustment-dock", css)
        self.assertIn('id="ductAdjustmentDock"', html)
        self.assertIn('id="heightConsistencyBadge"', html)
        self.assertIn("duct-designer.js?v=12", html)
