...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_duct_designer_is_an_independent_visual_project_tool(self):
        ...
        portal = (self.dist / "index.html").read_text(encoding="utf-8")
        self.assertIn("Editor de planos y conductos", html)
        self.assertIn("Dibuja la vivienda", html)
        self.assertIn('data-tool="room"', html)
        self.assertIn('data-tool="duct"', html)
        self.assertIn('data-tool="outlet"', html)
        self.assertIn("calculateProject", script)
        self.assertIn("renderPlanSvg", script)
        self.assertIn("routeEdgesFromPoints", script)
        self.assertIn("st.ductDesigner.v2", script)
        self.assertIn("installation-plan", css)
        self.assertIn("ventilationRole", script)
