...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_duct_designer_is_an_independent_visual_project_tool(self):
        ...
        portal = (self.dist / "index.html").read_text(encoding="utf-8")
        self.assertIn("Del plano a los conductos en tres pasos", html)
        self.assertIn('id="roomType"', html)
        self.assertIn('data-go-step="2"', html)
        ...
        self.assertIn("findAutomaticPath", script)
        self.assertIn("st.ductDesigner.v3", script)
        self.assertIn("installation-plan", css)
        self.assertIn("assistant-steps", css)
