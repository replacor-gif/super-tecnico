...
class HiddenElectroIATests(unittest.TestCase):
    ...
    def test_static_build_includes_the_hidden_lab(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertTrue((output / "data" / "electroia" / "diagram-spec.schema.json").is_file())
    ...
    def test_ai_discovery_files_are_consistent_and_keep_remote_execution_private(self):
        ...
        self.assertTrue(discovery["security"]["public_metadata_and_limited_search"])
        ...
        self.assertEqual(bridge["public_resources"]["diagram_spec_schema"], "diagram-spec.schema.json")
        self.assertIn("electroia_compile_diagram", bridge["response_contract"]["preferred_response"])
